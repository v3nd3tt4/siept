        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br><br>
                    <form action="<?=base_url()?>master/dasar/update" method="POST">
                        <div class="form-group">
                            <label for="">Text:</label>
                            <input type="hidden" class="form-control" name="id_dasar" id="id_dasar" value="<?=$dasar->row()->id_dasar?>">
                            <textarea name="text" id="text" class="form-control"><?=$dasar->row()->text?></textarea>
                        </div>
