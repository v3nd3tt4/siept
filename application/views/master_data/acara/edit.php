                ...
                <div class="card-body">
                    ...
                    <form action="<?=base_url()?>master/acara/update" method="POST">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id_acara" id="id_acara" value="<?=$acara->row()->id_acara?>">
                            <textarea name="text" id="text" class="form-control"><?=$acara->row()->text?></textarea>
                        </div>
