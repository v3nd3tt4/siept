        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?=base_url()?>master/guna/tambah" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah Master Data guna</a>
                    <br>
                    </p>
                    <br><br>
                    <table id="dataTable" class="table table-striped">
                        ...
                        <tbody>
                            <?php $no=1;foreach($guna->result() as $rguna){ 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?=base_url()?>master/guna/edit/<?=$rguna->id_guna?>" class="btn btn-success btn-sm"> <i class="fa fa-pencil"></i> Edit</a>
                                    <a href="<?=base_url()?>master/guna/hapus/<?=$rguna->id_guna?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');"> <i class="fa fa-remove"></i> Hapus</a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
