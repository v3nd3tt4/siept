        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br><br>
                    <form action="<?=base_url()?>master/guna/update" method="POST">
                        <div class="form-group">
                            <label for="">Text:</label>
                            <input type="hidden" class="form-control" name="id_guna" id="id_guna" value="<?=$guna->row()->id_guna?>">
                            <textarea name="text" id="text" class="form-control"><?=$guna->row()->text?></textarea>
                        </div>
