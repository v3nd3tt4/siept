                ...
                <div class="card-body">
                    ...
                    <form action="<?=base_url()?>user/update" method="POST">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id_user" id="id_user" value="<?=$user->row()->id_user?>">
                            <input type="text" name="username" id="username" class="form-control" value="<?=$user->row()->username?>" readonly/>
                        </div>
                        <div class="form-group">
                            <label for="">Password:</label>
                            <input type="password" class="form-control" name="password" value="<?=$user->row()->password?>"/>
                        </div>
                        <div class="form-group">
                            <label for="">Nama:</label>
                            <input type="text" class="form-control" name="nama_user" value="<?=$user->row()->nama_user?>"/>
                        </div>
                        <div class="form-group">
