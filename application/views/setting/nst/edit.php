        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br><br>
                    <form action="<?=base_url()?>setting/nst/update" method="POST">
                        <div class="form-group">
                            <label for="">Nomor Urut Terakhir:</label>
                            <input type="hidden" class="form-control" name="id_nst" id="id_nst" value="<?=$nst->row()->id_no_surat_terakhir?>">
                            <input type="number" id="nomor_terakhir" name="nomor_terakhir" class="form-control" value="<?=$nst->row()->nomor_terakhir?>">
                        </div>
                        <div class="form-group">
                            <label for="">Aktif:</label>
                            <select name="status" id="status" class="form-control">
                                <option value="">--pilih--</option>
                                <option value="ya" <?=$nst->row()->status == 'ya' ? 'selected' : ''?>>ya</option>
                                <option value="tidak" <?=$nst->row()->status == 'tidak' ? 'selected' : ''?>>tidak</option>
                            </select>
                        </div>
