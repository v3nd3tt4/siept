        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- <a href="<?=base_url()?>master/acara/tambah" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah Master Data acara</a> -->
                    <!-- <br>
                    </p>
                    <br><br> -->
                    <table id="dataTable" class="table table-striped">
                        ...
                        <tbody>
                            <?php $no=1;foreach($nst->result() as $rnst){ 
                                
                            ?>
                            <tr>
                                <td><?=$no++?>.</td>
                                <td><?=$rnst->nomor_terakhir?></td>
                                <td><?=$rnst->status?></td>
                                <td>
                                    <!-- <button class="btn btn-warning btn-sm">Detail</button> -->
                                    <a href="<?=base_url()?>setting/nst/edit/<?=$rnst->id_no_surat_terakhir?>" class="btn btn-success btn-sm"> <i class="fa fa-pencil"></i> Edit</a>
                                    <!-- <a href="<?=base_url()?>setting/nst/hapus/<?=$rnst->id_no_surat_terakhir?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');"> <i class="fa fa-remove"></i> Hapus</a> -->
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
